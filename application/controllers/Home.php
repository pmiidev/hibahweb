...
class Home extends CI_Controller
{
	...
	function index()
	{
		...
		$data['link_fb'] = $site_info->site_facebook;
		$data['link_ig'] = $site_info->site_instagram;
		$data['link_twit'] = $site_info->site_twitter;
		$data['link_linked'] = $site_info->site_linkedin;
