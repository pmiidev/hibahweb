<footer id="footer">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    ...
                    <form action="" method="post">
                        <input type="email" name="email" placeholder="Insert your email"><input type="submit" value="Subscribe">
                    </form>
                </div>
            </div>
        </div>
    ...
    <div class="container py-4">
        <div class="copyright">
            &copy; Copyright <strong><span>PMIIDev</span></strong> 2021
        </div>
        <div class="credits">
