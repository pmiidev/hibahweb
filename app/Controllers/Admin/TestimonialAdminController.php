...
class TestimonialAdminController extends BaseController
{
    ...
    public function insert()
    {
        ...
        if ($filefoto->isValid()) {
            ...
            $filefoto->move('assets/lte4/img/additional/testimonials/', $namaFotoUpload);
        } else {
    ...
    public function update()
    {
        ...
        if ($fileFoto->getName() == '') {
            ...
            if ($fotoAwal != 'user_blank.png' && file_exists('assets/lte4/img/additional/testimonials/' . $fotoAwal)) {
                unlink('assets/lte4/img/additional/testimonials/' . $fotoAwal);
            }
        }
    ...
    public function delete()
    {
        ...
        $testimonial = $this->testimonialModel->find($testimonial_id);
        $foto = $testimonial['testimonial_image'];
        // Hapus gambar jika bukan default
        if ($foto != 'user_blank.png' && file_exists('assets/lte4/img/additional/testimonials/' . $foto)) {
            unlink('assets/lte4/img/additional/testimonials/' . $foto);
        }
