...
class TeamAdminController extends BaseController
{
    ...
    public function insert()
    {
        ...
        if ($filefoto->isValid()) {
            ...
            $filefoto->move('assets/lte4/img/additional/teams/', $namaFotoUpload);
        } else {
    ...
    public function update()
    {
        ...
        if ($fileFoto->getName() == '') {
            ...
            if ($fotoAwal != 'user_blank.jpg' && file_exists('assets/lte4/img/additional/teams/' . $fotoAwal)) {
                unlink('assets/lte4/img/additional/' . $fotoAwal);
            }
        }
    ...
    public function delete()
    {
        ...
        $team = $this->teamModel->find($team_id);
        $foto = $team['team_image'];
        // Hapus gambar jika bukan default
        if ($foto != 'user_blank.jpg' && file_exists('assets/lte4/img/additional/teams/' . $foto)) {
            unlink('assets/lte4/img/additional/teams/' . $foto);
        }
