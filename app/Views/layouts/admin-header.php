...
<head>
  ...
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.1/css/all.min.css"
    integrity="sha512-DTOQO23CXSTF0E3B69IVUjVpkm+5og2FrEiJiWks4j+GA2IkaGKIeles3cSM0ri+7vE4HNIREt0rmtLS7YUJJA=="
    crossorigin="anonymous" referrerpolicy="no-referrer" />
  <link rel="stylesheet" href="<?= base_url(''); ?>assets/lte4/css/adminlte.css" />
  <!-- Summernote CSS -->
  <link href="<?= base_url('assets/lte4/sum/summernote-bs5.min.css'); ?>" rel="stylesheet">
</head>
        ...
        <ul class="navbar-nav ms-auto">
          ...
          <li class="nav-item dropdown user-menu">
            <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
              <img src="<?= base_url(''); ?>assets/lte4/img/additional/users/<?= $akun['user_photo']; ?>"
