...
<body class="page-header-fixed  compact-menu  pace-done page-sidebar-fixed">
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-white">
                            <div class="panel-body">
                                <button type="button" class="btn btn-success m-b-sm" data-toggle="modal" data-target="#myModal">Add New Testimonial</button>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td style="vertical-align: middle;">
                                                        ...
                                                        <?php else : ?>
                                                            <img class="img-circle" width="50" src="/assets/backend/images/testi/<?= $row['testimonial_image']; ?>">
                                                        <?php endif; ?>
                                                    </td>
                                                    <td style="vertical-align: middle;"><?= $row['testimonial_name']; ?>
                                                    </td>
                                                    <td style="vertical-align: middle;"><?= $row['testimonial_angkatan']; ?>
                                                    </td>
                                                    <td style="vertical-align: middle;"><?= $row['testimonial_content']; ?>
                                                    </td>
                                                    <td style="vertical-align: middle;">
                                                        <div class="btn-group">
                                                            ...
                                                            <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                                                <li><a href="javascript:void(0);" data-toggle="modal" data-target="#ModalEdit<?= $row['testimonial_id']; ?>"><span class="icon-pencil"></span> Edit</a></li>
                                                                <li><a href="javascript:void(0);" class="delete" data-userid="<?= $row['testimonial_id']; ?>"><span class="icon-trash"></span> Delete</a></li>
                                                            </ul>
                                                        </div>
                                                    </td>
                                                </tr>
    ...
    <!-- Modal Add -->
    <form id="add-row-form" action="/<?= session('role'); ?>/testimonial" method="POST" enctype="multipart/form-data">
    ...
    ?>
        ...
        <form id="add-row-form" action="/<?= session('role'); ?>/testimonial" method="POST" enctype="multipart/form-data">
            ...
            <div class="modal fade" id="ModalEdit<?= $row['testimonial_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <input type="file" name="filefoto" class="dropify" data-height="180" data-default-file="/assets/backend/images/testi/<?= $row['testimonial_image']; ?>">
                                    </div>
                                </div>
                                <div class="col-md-8">
                                    <div class="form-group">
                        ...
                        <div class="modal-footer">
                            <input type="hidden" name="testimonial_id" value="<?= $row['testimonial_id']; ?>" required>
                            <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
