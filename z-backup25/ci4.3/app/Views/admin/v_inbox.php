...
<body class="page-header-fixed compact-menu pace-done page-sidebar-fixed">
                                        ...
                                        <tbody id="body-table">
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?= ($inbox['inbox_status'] == 0) ? 'Unread' : 'Read'; ?></td>
                                                    <td style="text-align: center;">
                                                        <a href="/<?= session('role'); ?>/inbox/<?= $inbox['inbox_id']; ?>" class="btn btn-xs"><span class="fa fa-envelope"></span></a>
                                                        <a href="javascript:void(0);" class="btn btn-xs btn-delete" data-id="<?= $inbox['inbox_id']; ?>"><span class="fa fa-trash"></span></a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
    ...
    <!--DELETE RECORD MODAL-->
    <form action="/<?= session('role'); ?>/inbox" method="post">
    ...
    <?php elseif (session()->getFlashData('msg') == 'warning') : ?>
        <script type="text/javascript">
            $.toast({
                heading: 'Warning',
                text: "Inbox Not Found",
                showHideTransition: 'slide',
                icon: 'warning',
                hideAfter: false,
                position: 'bottom-right',
